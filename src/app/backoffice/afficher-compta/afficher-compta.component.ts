...
@Component({
  selector: 'app-afficher-compta',
  templateUrl: './afficher-compta.component.html',
  styleUrls: ['./afficher-compta.component.css']
})
export class AfficherComptaComponent implements OnInit {
